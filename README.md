...
then installs them under `$ADOFAI_MODS_DIR/EnhancedCountdown/`. The runtime lives at
...
selects a release, verifies its tag and `EnhancedCountdown.update.json`, checks the complete ZIP size and SHA-256,
...
- `build/EnhancedCountdown.zip`
- `build/EnhancedCountdown.update.json`

The manifest contains the version, package size, SHA-256, and `EnhancedCountdown/Runtime/versions/<version>` path.
