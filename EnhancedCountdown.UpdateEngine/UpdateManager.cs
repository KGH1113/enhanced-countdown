...
internal sealed class UpdateManager
{
  ...
  internal const string ManifestAsset = "EnhancedCountdown.update.json";
  internal const string PackageAsset = "EnhancedCountdown.zip";
  ...
  public UpdateResult Resolve(string currentVersion)
  {
    ...
    {
      throw new TimeoutException("EnhancedCountdown update operations timed out.");
    }
  }
  ...
  {
    string assemblyPath = Path.Combine(directory, "EnhancedCountdown.dll");
    string enginePath = Path.Combine(directory, "EnhancedCountdown.UpdateEngine.dll");
  ...
  private static HttpClient CreateClient()
  {
    ...
    client.DefaultRequestHeaders.UserAgent.ParseAdd("EnhancedCountdown-AutoUpdater/1.0");
    return client;
  }
